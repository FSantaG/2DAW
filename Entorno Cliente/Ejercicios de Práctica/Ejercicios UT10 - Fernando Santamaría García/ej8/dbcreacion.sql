CREATE USER 'ajaxFF'@'localhost' IDENTIFIED BY 'dwec1718';

GRANT USAGE ON * . * TO 'ajaxFF'@'localhost' IDENTIFIED BY 'dwec1718' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;

CREATE DATABASE IF NOT EXISTS `ajax` ;

GRANT ALL PRIVILEGES ON `ajax` . * TO 'ajaxFF'@'localhost';
